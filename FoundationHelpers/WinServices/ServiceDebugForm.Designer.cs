...
{
	partial class ServiceDebugForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "ServiceDebugForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ServiceDebugForm";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ServiceDebugForm_FormClosing);
